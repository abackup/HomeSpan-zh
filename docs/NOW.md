...
另请参阅 [SpanPointLightSwitch 库](https://github.com/HomeSpan/SpanPointLightSwitch/tree/main)，了解如何使用 SpanPoint 在实现两个 HomeKit 灯泡配件的 ESP32 “中央集线器”设备、控制 LED 的远程 ESP32 设备和控制另一个 LED 的单独 ESP8266 设备之间进行双向通信。
